...
describe('property names come from the Code Clash master list; prices from the reference board', () => {
  const cases: [string, string, number][] = [
    ...
    ['loc-9',  'Mindtree',                   180],
    ['loc-10', 'L&T Technology Services',    200],
    ['loc-11', 'Accenture',                  220],
    ['loc-12', 'Cognizant',                  220],
    ['loc-13', 'Infosys',                    240],
    ['loc-14', 'Wipro',                      260],
    ['loc-15', 'HCLTech',                    260],
    ['loc-16', 'Tech Mahindra',              280],
    ['loc-17', 'Oracle',                     300],
    ['loc-18', 'Salesforce',                 300],
    ['loc-19', 'IBM',                        320],
    ['loc-20', 'Microsoft',                  350],
    ['loc-21', 'TCS',                        400],
